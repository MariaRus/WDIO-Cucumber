Feature: Testing kinopoisk.ru
  ...
  @Rating
  Scenario: get rating
    When I enter "Уэнсдей" in input field
    When I click on the link of this series
    Then I should see this series in "top 250"
  ...
  Scenario: Check random search
    When I click on the icon "Search"
    Then I should see the button "Случайный поиск"
